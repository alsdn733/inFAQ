      ...
      <div class="container">
      	<table class="table" border="1" cellspacing="0">
      		...
      		<tr>
          		...
          		<th scople="col" width="8%">문의 수</th>
          		<th scople="col" width="1%">추천</th>
          		<th scople="col" width="1%">수정</th>
          		<th scople="col" width="1%">삭제</th> 
      		</tr>
      		</thead>
      		<tbody>
     			<c:forEach var="faqContent" items="${ faqContent }" varStatus="status">
      				<tr>
      					...
      					<td><input type="button" class="btn btn-primary" value="수정" onClick="location.href='<c:url value="/edit/${ faqContent.no }" />'"></td>
      					<td><button type="button" class="btn btn-danger btn-xs" onClick="location.href='<c:url value="/deleteContent/${ faqContent.no }" />'">삭제</button></td>
      				</tr>
   				</c:forEach>
      		</tbody>
    	</table>
