...
// 파일 업로드 http://handcoding.tistory.com/16
public class HandcodingController {
	...
	public String multiplePhotoUpload(HttpServletRequest request){
		...
		try{
			...
			// 파일 기본경로 _ 상세경로
			String filePath ="E:/workspace/FAQ/src/main/webapp/resources/photoUpload/";
			...
			sb.append("&bNewLine=true")
			  ...
			  .append("&sFileURL=").append("http://localhost:8080/myapp/resources/photoUpload/")
			  .append(saveName);
		}catch(Exception e){
			e.printStackTrace();
		}
